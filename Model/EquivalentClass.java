...
public class EquivalentClass {
    ...
    public void decodingEquivalentClass(Context context, final String helpStr, Integer objectID) {
        try {
            saveEquivalentClass(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveEquivalentClass(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("EquivalentClass");
