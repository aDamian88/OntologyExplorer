...
public class InverseOf {
    ...
    public void decodingInverseOf(Context context, final String helpStr, Integer objectID) {
        try {
            saveInverseOf(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveInverseOf(Context context, String saving,Integer objectID) {
