...
public class SomeValuesFrom {
    ...
    public void decodingSomeValuesFrom(Context context, final String helpStr, Integer objectID) {
        try {
            saveSomeValuesFrom(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveSomeValuesFrom(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("SomeValuesFrom");
