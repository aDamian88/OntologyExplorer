...
public class Cardinality {
    ...
    public void decodingCardinality(Context context, final String helpStr, Integer objectID) {
        try {
            saveCardinality(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveCardinality(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("Cardinality");
