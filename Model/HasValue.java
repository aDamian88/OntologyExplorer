...
public class HasValue {
    ...
    public void decodingHasValue(Context context, final String helpStr, Integer objectID) {
        try {
            saveHasValue(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveHasValue(Context context, String saving,Integer objectID) {
