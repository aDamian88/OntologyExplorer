...
public class MaxCardinality {
    ...
    public void decodingMaxCardinality(Context context, final String helpStr, Integer objectID) {
        try {
            saveMaxCardinality(context, helpStr,objectID);
            Log.d("maxCardinality", String.valueOf("max!!!"));
    ...
    public void saveMaxCardinality(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("MaxCardinality");
