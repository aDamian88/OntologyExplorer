...
public class SubPropertyOf {
    ...
    public void decodingSubPropertyOf(Context context, final String helpStr, Integer objectID) {
        try {
            saveSubPropertyOf(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveSubPropertyOf(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("SubPropertyOf");
