...
public class IntersectionOf {
    ...
    public void decodingIntersectionOf(Context context, final String helpStr,Integer objectID) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Log.d("intersection0", String.valueOf(jsonObjectStr));
                if (jsonObjectStr != null) {
                    Log.d("intersectionn1", String.valueOf(jsonObjectStr));
                    saveIntersectionOf(context, jsonObjectStr,objectID);
                } else {
                    saveIntersectionOf(context, helpStr,objectID);
                    break;
                }
            }
    ...
    public void saveIntersectionOf(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("IntersectionOf");
