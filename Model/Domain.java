...
public class Domain {
    ...
    public void decodingDomain(Context context, final String helpStr, Integer objectID) {
        try {
            saveDomain(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveDomain(Context context, String saving,Integer objectID) {
