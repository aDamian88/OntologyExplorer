...
public class OneOf {
    ...
    public void decodingOneOf(Context context, final String helpStr, Integer objectID) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (jsonObjectStr != null) {
                    saveOneOf(context, jsonObjectStr,objectID);
                } else {
                    saveOneOf(context, helpStr,objectID);
                    break;
                }
            }
        } catch (Exception e) {
    ...
    public void saveOneOf(Context context, String saving,Integer objectID) {
