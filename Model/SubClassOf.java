...
public class SubClassOf {
    ...
    public void decodingSubClassOf(Context context, final String helpStr, Integer objectID) {
        try {
            saveSubClassOf(context, helpStr,objectID);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void saveSubClassOf(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("SubClassOf");
