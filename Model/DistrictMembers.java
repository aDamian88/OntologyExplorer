...
public class DistrictMembers {
    ...
    public void decodingDistrictMembers(Context context, final String helpStr, Integer objectID) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (jsonObjectStr != null) {
                    saveDistrictMembers(context, jsonObjectStr,objectID);
                }
            }
    ...
    public void saveDistrictMembers(Context context, String saving,Integer objectID) {
        ...
        try {
            ...
            for (int j = 0; j < propertyArray.length(); j++) {
                ...
                objectData.setModel("DistrictMembers");
